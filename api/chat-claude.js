// Sèvè entèmedyè inik pou TOUT chat IA nan aplikasyon an (Chat Sipò piblik
// AK Chat Antretyen CEO) — itilize sèlman API Claude (Anthropic).
// OpenAI pa itilize ankò nan aplikasyon an.
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const supportPrompt =
      "Ou se Chat Sip\u00f2, asistan vityèl aplikasyon SekouPy\u00e8s, yon platf\u00f2m ann Ayiti " +
      "ki konekte moun ki p\u00e8di py\u00e8s idantite yo (paspò, CIN/NIF, lisans, elatriye) ak moun ki " +
      "jwenn yo a. Ou ap pale ak itilizat\u00e8 aplikasyon an dirèkteman. Ede yo konprann kijan " +
      "pou yo pibliye yon py\u00e8s, kijan pou yo ch\u00e8che youn, kijan sistèm frè s\u00e8vis volont\u00e8 a " +
      "(MonCash/NatCash) fonksyone, ak kijan pou yo rete an sekirite. Rete cho, klè, e toujou " +
      "reponn an Kreyòl Ayisyen sof si moun nan ekri nan yon lòt lang.";

    const maintenancePrompt =
      "Ou se asistan teknik entèn pou aplikasyon SekouPy\u00e8s. Ou ap pale sèlman " +
    ...
    const systemPrompt = context === "maintenance" ? maintenancePrompt : supportPrompt;
